...
- **Brief Description:** This project builds tooling and implements a pilot project for fiscal sponsorship using national currencies (e.g. USD). It builds and demonstrates a means for unbanked DAOs to receive and spend funds within the mainstream banking system. The pilot project will be executed under US law; the tooling is not country-specific. Background: "Fiscal Sponsorship" is a well-established practice whereby small or loosely-organized projects performing charitable activities (e.g. education, arts, civics) can accept tax-exempt donations without the legal overhead of becoming recognized charities on their own. The sponsored project's activities are declared as a program of an "umbrella" or sponsor organization with legal tax-exempt status; the sponsor then accepts and holds contributions on behalf of the sponsored group and is accountable for proper disbursement of funds.
...
- **Relationship to EOS Network / Antelope:** This project is Antelope-based. The pilot project will be deployed on Telos using the well-established `atomicassets` Antelope NFT contract and a Hypha DAO (SEEDS Educaton and Research Program Office DAO). The deliverable project software will be applicable across the Antelope ecosystem and the sponsored organization can be any DAO or non-DAO group.
