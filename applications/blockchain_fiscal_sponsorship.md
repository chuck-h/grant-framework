...
- **Project Name:** Blockchain Fiscal Sponsorship
- **Team Name:** Legal applicant: Department of Bioregion, Inc. (as fiscal sponsor)
- **EOS Payment Address:** EOS payment address TBD
...
- **Contact Name:** Charles F. ("Chuck") Harrison
- **Contact Email:** cfharr@gmail.com
...
- **Name:** Blockchain Fiscal Sponsorship for Distributed Nonprofit Organizations
- **Brief Description:** This project builds tooling and implements a pilot project for fiscal sponsorship using national currencies (e.g. USD). It builds and demonstrates a means for unbanked DAOs to receive and spend funds within the mainstream banking system. The pilot project will be executed under US law; the tooling is not country-specific.

  Background: "Fiscal Sponsorship" is a well-established practice whereby small or loosely-organized projects performing charitable activities (e.g. education, arts, civics) can accept tax-exempt donations without the legal overhead of becoming recognized charities on their own. The sponsored project's activities are declared as a program of an "umbrella" or sponsor organization with legal tax-exempt status; the sponsor then accepts and holds contributions on behalf of the sponsored group and is accountable for proper disbursement of funds.

  This project applies the fiscal sponsorship model to distributed blockchain organizations, such as DAOs, who have no legal existence and are therefore unbanked. The tooling uses NFTs to provide a transparent, immutable accounting trail for each decision to disburse funds. A mutable NFT will track each expense invoice from creation thru approval and payment steps. A web interface will demonstrate a non-technical UX for accounting interactions.
- **Relationship to EOS Network / Antelope:** This project is Antelope-based. The pilot project will be deployed on Telos using the well-established `atomicassets` Antelope NFT contract and a Hypha DAO (SEEDS Educational and Charitable Program Office DAO). The deliverable project software will be applicable across the Antelope ecosystem and the sponsored organization can be any DAO or non-DAO group.
- **Reason for Interest:** The SEEDS project (active since 2018) has been researching methods to accept fiat donations in a direct legal fashion. We have discovered this approach and believe that implementing it as a pulic good will serve not only our own projects but also hundreds of other charitable projects operating in the decentralized blockchain universe. We intend to demonstrate a pattern which can be easily replicated by other organizations, both inside and outside our "Regenerative Renaissance" ecosystem.
